      ...
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            User_1.default
              .findByIdAndUpdate(id, update, options, function (err, doc) {
                if (!err) {
...
var removeConnection = function (req, res, next) {
  return __awaiter(void 0, void 0, void 0, function () {
...
var userFollowAll = function (req, res, next) {
  return __awaiter(void 0, void 0, void 0, function () {
