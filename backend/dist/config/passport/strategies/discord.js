...
var discordStrategySettings = {
  clientID: ''.concat(process.env.DISCORD_CLIENT_ID),
  clientSecret: ''.concat(process.env.DISCORD_CLIENT_SECRET),
  callbackURL: '/api/auth/discord/callback',
  scope: discordScopes,
  passReqToCallback: true,
};
exports.discordStrategy = new DiscordStrategy(
...
function handleDiscordLogin(
  ...
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      if (
        !discordProfile.guilds.some(function (guild) {
          return guild.id === '735923219315425401';
        })
      ) {
          ...
          return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
              switch (_a.label) {
                case 0:
                  if (err) {
                    return [2 /*return*/, callback(err, null)];
                  }
                  if (userInDatabase) {
                    return [2 /*return*/, callback(null, userInDatabase)];
                  }
                  newUser = getNewUser(discordProfile, discordAccessToken);
                  return [4 /*yield*/, newUser.save()];
                case 1:
                  _a.sent();
                  return [2 /*return*/, callback(null, newUser)];
              }
            });
          });
        }
...
function getNewUser(discordProfile, discordAccessToken) {
